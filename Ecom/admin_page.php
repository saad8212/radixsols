   ...
   <div class="product-display">
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               <a href="top.php?edit=<?php echo $row['Product_ID']; ?>"  class="btn"> <i class="fa fa-edit"></i> edit </a>
               <a href="admin_page.php?delete=<?php echo $row['Product_ID']; ?>"  class="btn"> <i class="fa fa-trash"></i> delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
