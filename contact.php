        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div >
                    ...
                    <form action="<?php $_SERVER['PHP_SELF']?>" method="POST" id = "contacts">
                    
                            <input type="text" class="form-control" id="name" placeholder="Your Name"
                                required name = "name" data-validation-required-message="Please enter your name" />
                            ...
                            <input type="text" class="form-control" id="subject" placeholder="Subject"
                                required name = "subject" data-validation-required-message="Please enter a subject" />
                            <p class="help-block text-danger"></p>
                        ...
                        <div>
                            <input class="btn btn-primary py-2 px-4" type="submit"  name = "submit" id = "submitbtn">
                        </div>
                    </form>
                </div>
            </div>
            <div class="col-lg-5 mb-5">
                <div class="bg-light p-30 mb-30">
                    ...
                    src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=Johar town lahore pakistan&amp;t=&amp;z=17&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                    frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
                <div class="bg-light p-30 mb-3">
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Johar town J1 block, Lahore, Pakistan</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>https://www.radixsols.com/</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+92-305-6483484</p>
                </div>
            </div>
        </div>
    </div>
