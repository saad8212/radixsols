...
<body>
    ...
    <div class="container-fluid bg-dark mb-30" role = "button">
        ...
        <div class="container-fluid">
            <div class="col-lg-12 col-md-8">
                <div class="row pb-3">
                    ...
                    <?php  
                     $select = mysqli_query($conn, "SELECT * FROM product where Category_ID =$id");
                     while($row = mysqli_fetch_assoc($select)){ ?>
                    
                    <div 
                        class="col-lg-3 col-md-6 col-sm-6 pb-1" onclick="location.href='detail.php?id=<?php echo $row['Product_ID']; ?>'" role = "button">
                        <div class="product-item bg-light mb-4">
                            <div 
                                class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="Ecom/uploaded_img/<?php echo $row['product_image']; ?>" alt="">
                            </div>
                        </div>
                        <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href=""><?php echo $row['product_name']; ?></a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5><?php echo $row['product_price']; ?></h5><h6 class="text-muted ml-2"><del><?php echo $row['product_price'] * 1.25; ?></del></h6>
                        </div>
                                <form method = "post">
                                ...
                                ?>"> 
                                 <button name = "add_to_cart"  type = "submit" class="btn btn-primary center-text"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                                </form>
                    </div>
